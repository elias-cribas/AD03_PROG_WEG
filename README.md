# Programação Web - AD3 - Atividade Avaliativa a Distância
Atividade de AD03 de Programação Web

Implemente a aplicação de exemplo, conforme os tópicos apresentados na Unidade 3.

Adicione as funcionalidades para o cadastro de Cursos. Considere, nesta etapa, que os dados estarão em um arquivo public/cursos.json, cujo conteúdo é o que segue:
```
[
    {
        "id": 1,
